...
public class MXRefreshView extends RecyclerView {
    ...
    public ArrayList<View> mFootViews = new ArrayList<>();
    private Adapter mAdapter;
    public Adapter mWrapAdapter;
    private float mLastY = -1;
    private static final float DRAG_RATE = 3;
    private MXRefreshView.LoadingListener mLoadingListener;
    ...
    public MXRefreshView(Context context) {
        this(context, null);
    }

    public MXRefreshView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MXRefreshView(Context context, AttributeSet attrs, int defStyle) {
...
//        return false;
        ...
        public void onChanged() {
            ...
            if (adapter != null && mEmptyView != null) {
                ...
                if (adapter.getItemCount() == emptyCount) {
                    ...
                    MXRefreshView.this.setVisibility(View.GONE);
                } else {
                    mEmptyView.setVisibility(View.GONE);
                    MXRefreshView.this.setVisibility(View.VISIBLE);
                }
            }
    ...
    public class WrapAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void setmFootViews(ArrayList<View> mFootViews) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == TYPE_REFRESH_HEADER) {
                mCurrentPosition++;
                return new WrapAdapter.SimpleViewHolder(mHeaderViews.get(0));
            } else if (isContentHeader(mCurrentPosition)) {
                if (viewType == sHeaderTypes.get(mCurrentPosition - 1)) {
                    mCurrentPosition++;
                    return new WrapAdapter.SimpleViewHolder(mHeaderViews.get(headerPosition++));
                }
            } else if (viewType == TYPE_FOOTER) {
                return new WrapAdapter.SimpleViewHolder(mFootViews.get(0));
            }
